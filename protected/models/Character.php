 ...
 * @property integer $points_per_villages
...
class Character extends CActiveRecord
{
	...
	public function tableName()
	{
            if ( strlen($this->scenario)==0 ) {
                $this->scenario = 'character_'.Yii::app()->controller->world;
            }
	...
	public function rules()
	{
		...
		return array(
			array('id, achievement_points, bash_points_def, bash_points_off, bash_points_total, name, villages, points, points_per_villages, rank', 'required'),
			array('achievement_points, bash_points_def, bash_points_off, bash_points_total, villages, points, points_per_villages, rank, tribe_id', 'numerical', 'integerOnly'=>true),
			array('id', 'length', 'max'=>10),
			array('name', 'length', 'max'=>32),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, achievement_points, bash_points_def, bash_points_off, bash_points_total, name, villages, points, points_per_villages, rank, tribe_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'achievement_points' => 'Achievment Points',
			...
			'villages' => 'Villages',
			'points' => 'Points',
			'points_per_villages' => 'Points Per Villages',
			'rank' => 'Rank',
			'tribe_id' => 'Tribe',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('achievement_points',$this->achievement_points);
		...
		$criteria->compare('points_per_villages',$this->points_per_villages);
