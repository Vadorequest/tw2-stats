...
class CKEditorWidget extends CInputWidget
{
	...
	public function run()
	{
		...
		if(!isset($this->ckEditor)){
			$this->ckEditor = Yii::app()->basePath."/../public_html/js/ckeditor/ckeditor.php";
                        //$this->ckEditor = Yii::app()->basePath."/../js/ckeditor/ckeditor.php";
		}
		if(!isset($this->ckBasePath)){
			$this->ckBasePath = Yii::app()->baseUrl."/js/ckeditor/";
		}
